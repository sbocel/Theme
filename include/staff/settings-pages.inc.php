...
<!--Fondo del Sistema-->
<div class="hidden tab_content" id="backdrops_sys">
<table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr>
            <th colspan="2">
            ...
            <td colspan="2">
                <table style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="radio" name="selected-backdrop_sys"
                                       style="margin-left: 1em" value="<?php
                            echo $logo->getId(); ?>" <?php
                            if ($logo->getId() == $current)
                                echo 'checked="checked"'; ?>/>
                            ...
                            <td>
                                ...
                                <?php if ($logo->getId() != $current && $logo->getId() != $currentScp) { ?>
                                <label class="checkbox inline">
                                    <input type="checkbox" name="delete-backdrop_sys[]" value="<?php
                                    echo $logo->getId(); ?>"/> <?php echo __('Delete'); ?>
                                </label>
                                <?php } ?>
                            </td>
                ...
                <b><?php echo __('Upload a new backdrop'); ?>:</b>
                <input type="file" name="backdrop_sys[]" size="30" value="" />
                <font class="error"><br/><?php echo $errors['backdrop_sys']; ?></font>
            </td>
        </tr>
    </tbody>
</table>
</div>
<!--Fondo de landingpage-->
<div class="hidden tab_content" id="backdrops_landings">
<table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr>
            <th colspan="2">
            ...
            <td colspan="2">
                <table style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php
                        $current = $ost->getConfig()->getStaffBackdrop_landingId();
                        foreach (AttachmentFile::allBackdrops_landing() as $logo) { ?>
                        <tr>
                            <td>
                                <input type="radio" name="selected-backdrop_landing"
                                       style="margin-left: 1em" value="<?php
                            echo $logo->getId(); ?>" <?php
                            if ($logo->getId() == $current)
                                echo 'checked="checked"'; ?>/>
                            ...
                            <td>
                                ...
                                <?php if ($logo->getId() != $current) { ?>
                                <label class="checkbox inline">
                                    <input type="checkbox" name="delete-backdrop_landing[]" value="<?php
                                    echo $logo->getId(); ?>"/> <?php echo __('Delete'); ?>
                                </label>
                                <?php } ?>
                            </td>
                ...
                <b><?php echo __('Upload a new backdrop'); ?>:</b>
                <input type="file" name="backdrop_landing[]" size="30" value="" />
                <font class="error"><br/><?php echo $errors['backdrop_landing']; ?></font>
            </td>
        </tr>
    </tbody>
</table>
